...
<body>
	...
	<p style="text-align:center">
		<a href="{{ route('page1') }}" @style(['text-decoration:underline' => url()->current() == route('page1')])>Page 1</a> &bull;
		<a href="{{ route('page2') }}" @style(['text-decoration:underline' => url()->current() == route('page2')])>Page 2</a>
	</p>
